...
$.fn.rating = function(params, callback) {
	...
	var rat = "" + settings.rate,
	split_rate = rat.split("."),
	box = $('<span class="text-star"></span>'),
	total_rates = $('<small id="total_rates"></small>'),
	current_poll = $.str_repeat('<small class="fa fa-star"></small>', split_rate[0]) + ((split_rate[1] != null) ? '<small class="fa fa-star-half-o"></small>' : "") + $.str_repeat('<small class="fa fa-star-o"></small>', (settings.stars - Math.ceil(settings.rate))),
